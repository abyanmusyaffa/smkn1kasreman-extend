<div class="f-carousel__slide !flex !justify-center !items-center">
    <div class="flex flex-col w-[96%] lg:w-[98%]">
        <figure class="h-44 lg:h-52 w-full rounded-t-3xl lg:border-4 border-2 border-b-0 border-blue-600 bg-cover bg-center bg-no-repeat" style="background-image: url(/storage/{{ $photo }})">
        </figure>
