...
class AcademicCalendarPolicy
{
    ...
    {
        return $user->can('view_any_academic::calendar');
    }
    ...
    {
        return $user->can('view_academic::calendar');
    }
    ...
    {
        return $user->can('create_academic::calendar');
    }
    ...
    {
        return $user->can('update_academic::calendar');
    }
    ...
    {
        return $user->can('delete_academic::calendar');
    }
    ...
    {
        return $user->can('delete_any_academic::calendar');
    }
     ...
     */
    public function replicate(User $user, AcademicCalendar $academicCalendar): bool
    {
