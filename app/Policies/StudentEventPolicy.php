...
class StudentEventPolicy
{
    ...
    {
        return $user->can('view_any_student::event');
    }
    ...
    {
        return $user->can('view_student::event');
    }
    ...
    {
        return $user->can('create_student::event');
    }
    ...
    {
        return $user->can('update_student::event');
    }
    ...
    {
        return $user->can('delete_student::event');
    }
    ...
    {
        return $user->can('delete_any_student::event');
    }
     ...
     */
    public function replicate(User $user, StudentEvent $studentEvent): bool
    {
