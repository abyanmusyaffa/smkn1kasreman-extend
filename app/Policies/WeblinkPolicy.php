...
class WeblinkPolicy
{
    ...
    {
        return $user->can('view_any_weblink');
    }
    ...
    {
        return $user->can('create_weblink');
    }
    ...
    {
        return $user->can('update_weblink');
    }
    ...
    {
        return $user->can('delete_weblink');
    }
    ...
    {
        return $user->can('delete_any_weblink');
    }
     ...
     */
    public function replicate(User $user, Weblink $weblink): bool
    {
